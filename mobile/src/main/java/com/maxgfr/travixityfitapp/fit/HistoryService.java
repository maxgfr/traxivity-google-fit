...
public class HistoryService {
    ...
    public void buildFitnessClientHistory(MainActivity main) {
        ...
        mClient = new GoogleApiClient.Builder(main)
                ...
                .enableAutoManage(main, 0, new GoogleApiClient.OnConnectionFailedListener() {
                    @Override
    ...
    public class InsertAndVerifyDataTask extends AsyncTask<Void, Void, Void> {
        ...
        private static final String TAG = "InsertAndVerifyDataTask";
    ...
    public class UpdateAndVerifyDataTask extends AsyncTask<Void, Void, Void> {
        ...
        private static final String TAG = "UpdateAndVerifyDataTask";
